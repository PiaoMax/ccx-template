...
module.exports = function(webpackEnv) {
  ...
  const getStyleLoaders = (cssOptions, preProcessor) => {
    const loaders = [
      ...
      // {
      //   loader: path.resolve('./config/themeloader'),
      //   options:{
      //     vars:'./src/theme/vars.less',
      //     dist:'./public/color.less'
      //   }
      // },
      {
      ...
      if(preProcessor === 'less-loader'){
        loaders.push(
            ...
            },
            {
              ...
              options: {
                additionalData: `@import "@/theme/vars.less";`,
                sourceMap: true,
                lessOptions:{
